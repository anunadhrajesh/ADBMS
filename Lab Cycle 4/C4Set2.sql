...
(1,'Main','Kottayam',10000),
(2,'Mallappally','Pathanamthitta',20000),
(3,'Ramapuram','Palakkad',30000),
(4,'Mavellikara','Alappuzha',40000),
(5,'shasthamangalam','Kollam',50000);
SELECT * FROM BRANCH;
...
#1
SELECT CUSTOMER.CID,CUSTOMER_NAME,BRANCH_NAME FROM BRANCH,CUSTOMER,DEPOSITOR,ACCOUNTS WHERE CUSTOMER.CID=DEPOSITOR.CID
 AND DEPOSITOR.ACCNO=ACCOUNTS.ACCNO AND ACCOUNTS.BID=1 
...
AND BRANCH.BRANCH_CITY='Palakkad'
GROUP BY DEPOSITOR.CID HAVING COUNT(DISTINCT BRANCH.BID)=(SELECT COUNT(BID) FROM BRANCH WHERE BRANCH_CITY='Palakkad');
